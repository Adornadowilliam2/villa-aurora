              ...
              <label htmlFor="avatar">
                <EditContainer>
                  <Avatar
                    src={
                      preview ??
                      `https://backend-villa-aurora-production.up.railway.app/storage/${user?.avatar}`
                    }
                    alt="Avatar"
                  />
                  <Overlay />
        ...
        <Box>
          ...
          <AvatarContainer>
            <Avatar
              ...
              alt="Avatar"
            />
            <EditIconButton onClick={handleEditClick} id="edit-account-icon">
              <EditIcon />
            </EditIconButton>
          </AvatarContainer>
          <Typography variant="h6" style={{ fontFamily: "Quicksand" }}>
            Username:{" "}
            <span style={{ color: "#007bff" }}>{user?.username ?? ""}</span>
          </Typography>
          <Typography variant="h6" style={{ fontFamily: "Quicksand" }}>
            Email: <span style={{ color: "#007bff" }}>{user?.email ?? ""}</span>
          </Typography>
          <Typography variant="h6" style={{ fontFamily: "Quicksand" }}>
            Mobile:{" "}
            <span style={{ color: "#007bff" }}>{user?.mobile ?? ""}</span>
          </Typography>
        </Box>
      )}
    </>
